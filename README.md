<h1>CoreV7 BETA<img src="https://github.com/note3crafter/Core-V5/blob/main/resources/icon.png" height="64" width="64" align="left"></img></h1>
<br />
...
- [Hier downloaden als Phar](https://poggit.pmmp.io/ci/note3crafter/Core-V6/Core-V6)!
- Bitte jeden Fehler umgehend Melden!!!
- InvMenu muss isntalliert sein! [Hier Downloaden](https://poggit.pmmp.io/r/208372/InvMenu_dev-187.phar)
...
- VoteSystem wurde Repaiert
- AFKSystem wurde Repaiert
- Weitere Kleinigkeiten die nicht verfügbar sind!
- Intregration von [BasicSpawnProtection](https://github.com/pmmp/BasicSpawnProtection)
- Einstellung für Despawnen von Blättern hinzugefügt
- JavaSneaking hinzugefügt
...
- 2GB Ram 
- 1GB Festplatte
- Nicht für Aternos Server geeignet!!!
